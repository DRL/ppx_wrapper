...
def run_fastblocksearch(profile, contig_header, contig_seq):
	print "Searching " + profile + " in " + contig_header
	temp_file = open(contig_header + ".temp", 'w')
	temp_file.write(">" + contig_header + "\n" + contig_seq)
	temp_file.close()
